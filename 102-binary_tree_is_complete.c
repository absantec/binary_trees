...
/**
 * new_node - The function that creates a new_node in a linked_list
 * @node: The type of pointer of node to be created
 ...
 * @head: The type head of node in the stack
 * @tail: The type tail of node in the stack
 */
